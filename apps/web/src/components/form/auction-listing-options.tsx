        ...
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
            ...
            <p className="text-muted-foreground text-xs font-normal">
              با فعال‌سازی، آگهی در بخش «مزایده‌ها» نمایش داده می‌شود و شما میتوانید قیمت شروع و قیمت فروش فوری برای محصول خود تعیین کنید. همچنین میتوانید زمان پایان مزایده را تعیین کرده تا پس از اتمام محصول به بالاترین قیمت پیشنهادی فروخته شود.
            </p>
          </div>
        </div>
      </CardHeader>

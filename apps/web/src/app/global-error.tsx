      ...
      <body className="bg-background text-foreground">
        <div className="flex min-h-screen items-center justify-center px-6 py-12">
          <div className="max-w-lg rounded-2xl border border-red-200 bg-card p-8 text-center shadow-sm dark:border-red-950/60">
            ...
            <h1 className="mt-3 text-2xl font-bold">مشکلی در اجرای وب‌سایت پیش آمد</h1>
            <p className="mt-3 text-sm leading-7 text-muted-foreground">
              صفحه‌ای که در حال بازدید آن بودید به‌دلیل خطای غیرمنتظره بسته شد. لطفاً دوباره تلاش کنید

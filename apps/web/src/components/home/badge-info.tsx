      ...
      <div className={OPTION_CARD_STYLE}>
        ...
        <div>
          ...
          <p className={OPTIONS_CARD_DESC}>
            محصولات دارای نشان تضمین دارای دکمه خرید مستقیم هستند و تضمین کالا را از فروشگاه ما
            دارند برای ضمانت محصول خود توسط فروشگاه با پشتیبانی در ارتباط باشید.
          </p>
        </div>
      </div>
      <div className={OPTION_CARD_STYLE}>

  ...
  return (
    <>
      ...
      <section className="sr-only">
        ...
        <p>
          جیپو بازار تخصصی تجهیزات آفرود است و کاربران می‌توانند آگهی ثبت کنند، قیمت‌ها را مقایسه
          کنند و برای خرید امن‌تر تصمیم بگیرند. اگر کاربران از دیوار، شیپور، ترب یا دودف برای جستجو

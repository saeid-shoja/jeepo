...
export function buildProductsListMetadata(options: {
  ...
  if (tab === 'SHOP') {
    return buildMetadata({
      ...
      keywords: ['فروشگاه لوازم آفرودی', 'خرید آنلاین لوازم آفرودی دست دوم', 'آگهی لوازم آفرودی دست دوم', 'تجهیزات دست دوم موتورسیکلت', 'بی سیم و تجهیزات مسیریابی', 'سایه بان آفرودی', 'رینگ و لاستیک آفرودی نو و دست دوم', 'چادرسقفی و لوازم کمپی دست دوم', 'کیت زیربندی', 'سوپرلیپ', 'سپر آفرودی'],
    });
  }

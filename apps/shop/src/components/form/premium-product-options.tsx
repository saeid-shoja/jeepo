...
export function PremiumProductOptions({
  ...
  applyStrengthened: _applyStrengthened,
  onGuaranteeChange: _onGuaranteeChange,
  onStrengthenedChange: _onStrengthenedChange,
  showStrengthened: _showStrengthened = true,
  showBoost = false,
  isBoosted = false,
  onBoostedChange,
